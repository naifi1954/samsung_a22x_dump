...
cat system/system/priv-app/SamSungCamera/SamSungCamera.apk.* 2>/dev/null >> system/system/priv-app/SamSungCamera/SamSungCamera.apk
rm -f system/system/priv-app/SamSungCamera/SamSungCamera.apk.* 2>/dev/null
